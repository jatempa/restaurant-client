      ...
      <form onSubmit={handleSubmit} className='login-form'>
        ...
        <div>
          ...
          {fieldErrors.firstLastName && (
            <p className='field-error'>{fieldErrors.firstLastName}</p>
          )}
        </div>
        <div>
          <Input
          ...
          {fieldErrors.secondLastName && (
            <p className='field-error'>{fieldErrors.secondLastName}</p>
          )}
        </div>
        <div>
          <Input
          ...
          {fieldErrors.cellphoneNumber && (
            <p className='field-error'>{fieldErrors.cellphoneNumber}</p>
          )}
        </div>
        <div className='auth-role'>
          ...
          <Select
            value={role}
            onValueChange={(value: string) => setRole(value as RoleValue)}
          >
            <SelectTrigger
              id='register-role'
              className='auth-role-select w-full'
            >
